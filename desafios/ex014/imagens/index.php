...
<body>
    ...
    <section>
        ...
        <ul>
            <li> <img src="imagens/100-reais.png" alt="nota de 100 reais" class="nota">x<?= $tot100 ?></li>
            <li><img src="imagens/50-reais.png" alt="nota de 50 reais" class="nota"> x<?= $tot50 ?></li>
            <li><img src="imagens/10-reais.png" alt="nota de 10 reais" class="nota"> x<?= $tot10 ?></li>
            <li><img src="imagens/5-reais.png" alt="nota de 5 reais" class="nota"> x<?= $tot5 ?></li>
        </ul>
    </section>
</body>
</html>